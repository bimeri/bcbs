...
>>>>>>> 0ba2c164f435d7079af88481321645c86080743c
        ...
        @endif
            <div class="cont col s12 m4 offset-m4">
                <div class="moda">
                    <form method="post" action="{{ route('user.login') }}">
                        ...
                        <div class="blue header lighten-1 white-text" style="height: 150px;">
                            ...
                            <h5 class="center">Sign in to Buea College of Biblical Studies</h5>
                        </div>
                        @if(count($errors) > 0)
                        <center>
                        ...
                        <div class="card-content w3-padding">
                            <div class="form-field input-field">
                                <i class="fa fa-users prefix w3-large blue-text"></i>
                                <input type="text" name="user_name" class="validate" id="username" value="{{ old('user_name') }}">
                                <label for="username">User Name</label>
                            </div>
                            <div class="form-field input-field">
                                <i class="fa fa-unlock-alt prefix w3-large blue-text"></i>
                            ...
                            <div class="form-field">
                                ...
                                <p class="right">
                                    <label class="w3-large"><a class="teal-text w3-medium">forgot password</a>&nbsp;&nbsp; <i class="fa fa-lock"></i></label>
                                </p>
                            </div><br>
                        </div>
                            <div class="form-field">
